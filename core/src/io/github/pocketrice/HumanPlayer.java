...
import static io.github.pocketrice.BotPlayer.weightedRandom;
...
public class HumanPlayer extends Player {
    ...
    public String toString() {
        return "HUMAN " + (playerName.isEmpty() ? playerId : playerName);
    }
    ...
    public static String prompt(String message, String errorMessage, String[] strs, boolean isFuzzy, boolean ignoreCase, boolean lineMode) // <+> APM 1.1; includes fuzzy search!!
    {
        ...
        while (true)
        {
            ...
            if (List.of(strs).contains(nextInput) || isFuzzy && fuzzyResult != null) {
                if (isFuzzy) System.out.println(ANSI_PURPLE + "Could not find " + nextInput + ", preferring " + fuzzyResult + " instead.\n");
                return fuzzyResult;
            } else {
